...
Type *generictype_type = NULL;
Type *valuetype_type = NULL;
Type *identitytype_type = NULL;
...
TypeSpec MULTI_GENERICTYPE_TS;
TypeSpec ANY_TS;
TypeSpec ANY_GENERICTYPE_TS;
TypeSpec ANY_VALUETYPE_TS;
TypeSpec ANY_IDENTITYTYPE_TS;
