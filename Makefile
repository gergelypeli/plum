...
VALUES     = value literal function boolean integer array reference type block record multi generic control stream iterator class circularray rbtree container map
